      ...
      <div className="mx-auto flex min-h-screen w-full max-w-6xl items-center px-6 py-16">
        <div className="grid w-full gap-12 md:grid-cols-[1.1fr_0.9fr]">
          <section className="flex flex-col justify-center">
            ...
            <p className="mt-6 text-base leading-7 text-[#5e4c3d] md:text-lg">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                href="/login"
                className="rounded-full bg-[#1f1b16] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#3a312a]"
              >
                幹事ログイン
              </a>
              <a
                href="/signup"
                className="rounded-full border border-[#1f1b16] px-6 py-3 text-sm font-semibold text-[#1f1b16] transition hover:bg-[#f3e8dd]"
              >
                アカウント作成
              </a>
            </div>
          ...
          <section className="rounded-3xl border border-[#e7d6c7] bg-white/80 p-8 shadow-[0_20px_50px_rgba(31,27,22,0.1)]">
